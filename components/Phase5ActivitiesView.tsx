                  ...
                  <div className="flex-1 w-full">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <input
                        ...
                        className="font-bold text-slate-900 text-lg bg-transparent border-b border-transparent hover:border-indigo-300 focus:border-indigo-500 focus:outline-none w-full transition-colors"
                      />
                    </div>
                    <div className="flex items-start gap-2 pl-7">
                        ...
                        <textarea
                          ...
                          className="text-sm text-slate-700 font-medium bg-transparent border-b border-transparent hover:border-slate-300 focus:border-indigo-500 focus:outline-none w-full transition-colors resize-none"
                          rows={1}
                        />
                    </div>
                  </div>
                              ...
                              <div className="flex-1 w-full pr-24"> {/* Padding right to avoid overlap with controls */}
                                  <div className="flex flex-col md:flex-row justify-between items-start gap-2">
                                      ...
                                      <input 
                                        ...
                                        className="font-bold text-slate-900 text-base bg-transparent border-b border-transparent hover:border-slate-300 focus:border-indigo-500 focus:outline-none w-full transition-colors placeholder-[#AAB4C8]"
                                  ...
                                  <textarea
                                    ...
                                    className="w-full text-slate-700 text-sm mt-3 leading-relaxed bg-[#FAFDFE] border border-slate-200 rounded p-3 focus:ring-2 focus:ring-indigo-200 focus:border-indigo-400 outline-none transition-shadow placeholder-[#AAB4C8]"
                                    rows={3}
                          ...
                          <div className="flex flex-wrap gap-2 text-xs mt-2 border-t border-slate-200 pt-3 items-center">
                             <span className="px-2.5 py-1 bg-white border border-slate-300 rounded text-slate-600 font-medium flex items-center gap-2 w-full md:w-auto">
                               ...
                               <input 
                                ...
                                className="bg-transparent border-none focus:outline-none w-full text-slate-700 font-medium placeholder-[#AAB4C8]"
